// ignore_for_file: unused_local_variable, prefer_const_constructors, prefer_typing_uninitialized_variables, avoid_print, unnecessary_null_comparison, avoid_unnecessary_containers, sized_box_for_whitespace, use_key_in_widget_constructors, prefer_final_fields, non_constant_identifier_names
                ...
                children: [
                   ...
                   Flexible(
                     ...
                     child: Column(
                       ...
                       children: [
                        Textfield('Phone',child: TextFormField(
                          onChanged: (value) { phone = value;},
                          decoration: InputDecoration(
                              hintText: '07 98 12 16 07',
                              border: InputBorder.none,
                              suffixIcon: Icon(Icons.phone, color: Colors.black,),
                            ),
                          ),
                        ),
                        Textfield('Location',child: TextFormField(
                                  ...
                                  child: Padding(
                                    ...
                                    child: image == null?
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text('Picture path',style: TextStyle(color: Colors.black.withOpacity(0.7)),),
                   ...
                   Flexible(
                     ...
                     child: Column(
                       ...
                       child: ElevatedButton(
                         ...
                         onPressed: () {
                            Navigator.push( context, MaterialPageRoute( builder: (context) => RootApp(usertype: 0,),),);
                         },
                         child:  Text('Sign up',
                           style: TextStyle(
                             fontFamily: 'Poppins',
                         ...
                         Container(
                           ...
                           child: ElevatedButton(
                             style: ElevatedButton.styleFrom(
                               ...
                               shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(28),side: BorderSide(width: 1.5,color: Colors.black)),
                             ),
                             onPressed: () {
