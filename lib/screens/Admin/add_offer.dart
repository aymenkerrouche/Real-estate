...
class _AddLogementState extends State<AddLogement> {
        ...
        child: Row(
          ...
          children: [
            Column(
              ...
              children: [
                Text("Logement type", style: TextStyle(color: appBarColor, fontWeight: FontWeight.w500, fontSize: 24,)),
              ],
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Textfield('TITLE',child: TextFormField(
                cursorColor: mainColor,
                onChanged: (value) { name = value;},
                decoration: InputDecoration(
                  hintText: 'Logement name',
                  border: InputBorder.none,
                  suffixIcon: Icon(Icons.home,color: mainColor,),
                ),
              ),
              ),
            ),
            ...
            Padding(
               padding: EdgeInsets.symmetric(horizontal: 10),
               child: Textfield('Description',child: TextFormField(
                cursorColor: mainColor,
                onChanged: (value) { description = value;},
                decoration: InputDecoration(
                  hintText: 'Logement description',
                  border: InputBorder.none,
                  suffixIcon: Icon(Icons.description ,color: mainColor,),
                ),
            ),
            ),
             ),
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 10),
              child: Textfield('Location',child: TextFormField(
                            onChanged: (value) { location = value as LatLng;},
                            decoration: InputDecoration(
            ...
            Padding(
               padding: EdgeInsets.symmetric(horizontal: 10),
               child: Textfield('Price',child: TextFormField(
            ...
            Row(
              ...
              children: [
                CustomStepper(lowerLimit: 0, upperLimit: 100, stepValue: 1, iconSize: 20, value: rooms,titre: 'Rooms',),
                CustomStepper(lowerLimit: 0, upperLimit: 100, stepValue: 1, iconSize: 20, value: bed,titre: 'bed',),
              ],
            ),
            SizedBox(height: size.height * 0.02,),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                CustomStepper(lowerLimit: 0, upperLimit: 100, stepValue: 1, iconSize: 20, value: bathroom,titre: 'bathroom',),
                CustomStepper(lowerLimit: 0, upperLimit: 100, stepValue: 1, iconSize: 20, value: visitors,titre: 'visitors',),
              ],
            ),
            SizedBox(height: size.height * 0.02,),
  ...
  void _submit() async {
    ...
    if (Tgl.Rent == true) {trad_type.add('Rent ');}
    if (Tgl.Sell == true) {trad_type.add(' Sell ');}
    if (Tgl.vacation == true) {trad_type.add(' Vacation');}
    ...
    if (response.statusCode == 200) {
      ...
      if (offer_id.error == null) {
        ...
        Navigator.pushAndRemoveUntil(context,MaterialPageRoute(builder: (BuildContext context){
        return RootApp(usertype: 0,); },), (roote) => false,);
      }
      MapScreen.adrs = null;
      data.clear();
    } else {
