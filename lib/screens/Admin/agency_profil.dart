        ...
        children: [
          ...
          Container(
            child: Row(
              ...
              children: [
                Expanded(
                  child: SettingBox(title: "12", icon: "assets/icons/house.svg",wid: 20.0,hei: 20.0,)
                ),
                SizedBox(width: 10,),
                Expanded(
                  child: SettingBox(title: "Constantine", icon: "assets/icons/location.svg",)
                ),
                SizedBox(width: 10,),
                Expanded(
