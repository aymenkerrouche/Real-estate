...
class mdps extends StatefulWidget {
  mdps({Key? key, required this.headerText, this.hintTexti, this.child})
      : super(key: key);
  String headerText;
  String? hintTexti;
  Widget? child;
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Center(
                  child: Text(
                DateFormat('yyyy / MM / dd').format(Daye.start),
                textAlign: TextAlign.center,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Center(
                  child: Text(
                DateFormat('yyyy / MM / dd').format(Daye.end),
                textAlign: TextAlign.center,
                style: TextStyle(color: appBarColor),
              )),
            ),
...
class _ImagesState extends State<Images> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Container(
          child: Images.listImage.isEmpty
              ? Container(
                  decoration: BoxDecoration(
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              child: Image.file(
                                File(Images.listImage[index].path),
                                fit: BoxFit.cover,
                              ),
                              onTap: () {
