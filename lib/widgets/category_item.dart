      ...
      child: AnimatedContainer(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 5,),
            Expanded(
              child: Text(data["name"], maxLines: 2, overflow: TextOverflow.ellipsis,  textAlign: TextAlign.center,
...
class Equip extends StatefulWidget {
  const Equip({ Key? key, required this.data }) : super(key: key);
  final data;
  @override
    ...
    return Container(
      ...
      child: Column(
          children: [
            ...
            SizedBox(height: 5,),
            Expanded(
              child: Text(widget.data["name"], maxLines: 2, overflow: TextOverflow.ellipsis,  textAlign: TextAlign.center,
